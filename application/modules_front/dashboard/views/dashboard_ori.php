                                    ...
                                    <div class="search-wrapper">
                                        <div class="pdd-vertical-10">
                                            ...
                                            <ul class="list-unstyled list-info">
                                                <li>
                                                    <a href="">
                                                        <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-1.jpg" alt="">
                                                        <div class="info">
                                                ...
                                                <li>
                                                    <a href="">
                                                        <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-5.jpg" alt="">
                                                        <div class="info">
                                                ...
                                                <li>
                                                    <a href="">
                                                        <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-4.jpg" alt="">
                                                        <div class="info">
                                        ...
                                        <div class="pdd-vertical-10">
                                            ...
                                            <ul class="list-unstyled list-info">
                                                <li>
                                                    <a href="">
                                                        <img class="thumb-img" src="<?php echo URL_IMG?>img-1.jpg" alt="">
                                                        <div class="info">
                                                ...
                                                <li>
                                                    <a href="">
                                                        <img class="thumb-img" src="<?php echo URL_IMG?>img-2.jpg" alt="">
                                                        <div class="info">
                        ...
                        <ul class="nav-right">
                            <li class="user-profile dropdown">
                                <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                    <img class="profile-img img-fluid" src="<?php echo URL_IMG?>user.jpg" alt="">
                                    <div class="user-info">
                                ...
                                <div class="chat">
                                    <div class="chat-user-list scrollable">
                                        <div class="chat-section">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-2.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-3.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-6.jpg" alt="">
                                                <div class="user-info">
                                        ...
                                        <div class="chat-section">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-10.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-11.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                                <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-9.jpg" alt="">
                                                <div class="user-info">
                                            ...
                                            <div class="text-center mrg-top-20">
                                                <div class="row">
                                                    <div class="col-md-6 ml-auto mr-auto text-center">
                                                        <img class="img-fluid border-radius-round" src="<?php echo URL_IMG?>avatars/user-1.jpg" alt="">
                                                    </div>
                                                </div>
                                            ...
                                            <table class="table table-lg table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="list-info">
                                                                <img class="thumb-img" src="<?php echo URL_IMG?>avatars/thumb-7.jpg" alt="">
                                                                <div class="info">
                                                                    <span class="title">Jordan Hurst</span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="pdd-vertical-10">
                                            <ul class="list-info">
                                                <li>
                                                    <img class="thumb-img img-circle" src="<?php echo URL_IMG?>others/thumb-1.jpg" alt="">
                                                    <div class="info">
                                                    ...
                                                    <div class="mrg-top-30">
                                                        ...
                                                        <ul class="list-members list-inline">
                                                            <li>
                                                                <a href="">
                                                                    <img src="<?php echo URL_IMG?>avatars/thumb-1.jpg" alt="">
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="">
                                                                    <img src="<?php echo URL_IMG?>avatars/thumb-2.jpg" alt="">
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="">
                                                                    <img src="<?php echo URL_IMG?>avatars/thumb-3.jpg" alt="">
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="">
                                                                    <img src="<?php echo URL_IMG?>avatars/thumb-4.jpg" alt="">
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="">
                                                                    <img src="<?php echo URL_IMG?>avatars/thumb-5.jpg" alt="">
                                                                </a>
                                                            </li>
