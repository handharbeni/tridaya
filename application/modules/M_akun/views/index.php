...
<body class="header-info">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="relative mrg-top-15">
                                ...
                                <span class="pdd-left-20">Super Admin</span>
                              </div>
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="relative mrg-top-15">
                                ...
                                <span class="pdd-left-20">Admin Cabang</span>
                              </div>
                            </td>
                            <td>
                              <div class="relative mrg-top-10">
              ...
              <div class="modal-content">
                <form action="" method="POST" id="formAdd">      
                  <div class="modal-header">
                    <h4 id="modalFormHeader">Tambah Akun</h4>
                  </div>
                   ...
                   <div class="row">
                     <div class="col-sm-6">
                        <div class="form-group">
                         ...
                         <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Akun" required="">
                     ...
                     <div class="col-sm-6">
                       <div class="form-group">
                         ...
                         <select  onchange="" name="level" id="level" class="form-control" required="">
  ...
  <script>
    $('.edit-notif').on('click', function(e) {
      ...
      if(!id) {
        $('#modalFormHeader').text('Tambah Akun');
      }
      else {
        $('#modalFormHeader').text('Ubah Akun');
      }
