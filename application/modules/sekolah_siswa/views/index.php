...
<body class="header-info">
        ...
        <div class="main-content">
          <div class="container-fluid">
            <div class="page-title">
              <h4>Siswa Sekolah (PG/TK/SD)
                <div class="pull-right">
                  <a href="<?php echo base_url()?>registrasi/sekolah" class="btn btn-rounded btn-success edit-notif" title="Tambah data"><i class="ti-plus pdd-right-5"></i> Tambah</a>
          ...
          <div class="modal fade" id="modalForm">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <form action="<?php echo base_url()?>sekolah/siswa/do_add" method="POST" id="formAdd">      
                  ...
                  <div class="modal-body">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <input type="number" name="usia_tahun" id="usia_tahun" class="form-control" min="0" placeholder="Tahun" required="">
                            <span class="input-group-addon">Tahun</span>
                            <input type="number" name="usia_bulan" id="usia_bulan" class="form-control" min="0" placeholder="Bulan">
                            <span class="input-group-addon">Bulan</span>
                          </div>
                          <label for="usia_tahun" generated="true" class="error"></label>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                         ...
                         <select name="agama_id" id="agama" class="" required="">
                         </select>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="alamat" id="alamat" class="form-control" placeholder="Alamat Tinggal" required="">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-12">
                            <div class="radio radio-inline">
                              <input type="radio" name="golongan_darah" id="goldar_a" value="A" checked="">
                              <label for="goldar_a">A</label>
                            </div>
                            <div class="radio radio-inline">
                              <input type="radio" name="golongan_darah" id="goldar_b" value="B">
                              <label for="goldar_b">B</label>
                            </div>
                            <div class="radio radio-inline">
                              <input type="radio" name="golongan_darah" id="goldar_ab" value="AB">
                              <label for="goldar_ab">AB</label>
                            </div>
                            <div class="radio radio-inline">
                              <input type="radio" name="golongan_darah" id="goldar_o" value="O">
                              <label for="goldar_o">O</label>
                            </div>
                            <div class="radio radio-inline">
                              <input type="radio" name="golongan_darah" id="goldar_null" value="-">
                              <label for="goldar_null">Tidak tahu</label>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Bahasa Ibu</label>
                          <div class="input-group">
                            <input type="text" name="bahasa_ibu" id="bahasa_ibu" class="form-control" placeholder="Bahasa Ibu" required="">
                            <span class="input-group-addon">etnis</span>
                            <input type="text" name="etnis" id="etnis" class="form-control" placeholder="Etnis">
                          </div>
                          <label for="bahasa_ibu" generated="true" class="error"></label>
                        </div>
                      </div>
                    </div>
          ...
          <div class="modal fade" id="modalFormOrtu">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <form action="<?php echo base_url()?>sekolah/siswa/do_edit_ortu" method="POST" id="formAddOrtu">      
                  <div class="modal-header">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Tempat/Tanggal Lahir</label>
                            <div class="timepicker-input input-group">
                              <input type="text" name="tempat_lahir" id="tempat_lahir_ortu" class="form-control" placeholder="Tempat Lahir" required="">
                              <span class="input-group-addon">
                                <i class="ti-calendar"></i>
                              </span>
                              <input type="text" name="tanggal_lahir" id="tanggal_lahir_ortu" class="form-control datepicker-2" placeholder="Tanggal Lahir" required="">
                            </div>
                            <label for="tempat_lahir_ortu" generated="true" class="error"></label>
                            <label for="tanggal_lahir_ortu" generated="true" class="error"></label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                         <label for="agama_id">Agama</label>
                         <select name="agama_id" id="agama_ortu" class="" required="">
                         </select>
                         <label for="agama_ortu" generated="true" class="error"></label>
                       </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="pendidikan" id="pendidikan_ortu" class="form-control" placeholder="Pendidikan" required="">
                        </div>
                      </div>
                    </div>
                    <div class="row">
  ...
  <script>
    ...
    var initDataTable = $('#tableData').DataTable({
      ...
      "order": [[1, 'ASC']],
      "ajax":{
            url :"<?php echo base_url()?>sekolah/siswa/get_datatable",
    ...
    function getDetail(id, callback) {
      if(id) {
        $.ajax({
          url: '<?php echo base_url();?>sekolah/siswa/get_siswa_by_id',
          data: { id: id },
          type: 'POST',
          dataType: 'json',
          beforeSend: function() { },
          success: function(response, status) {
            if(response.status) {
              ...
              $('#usia_tahun').val(data.usia_tahun);
              $('#usia_bulan').val(data.usia_bulan);
              $('#alamat').val(data.alamat);
              $('#no_telp').val(data.no_telp);
              $('#no_hp').val(data.no_hp);
              $('#anak_ke').val(data.anak_ke);
              $('#jml_bersaudara').val(data.jml_bersaudara);
              $('#bahasa_ibu').val(data.bahasa_ibu);
              $('#etnis').val(data.etnis);
              selectizeAgama.setValue(data.agama_id, false);
              $('input:radio[name=jk]').val([data.jk]);
              $('input:radio[name=golongan_darah]').val([data.golongan_darah]);
    ...
    function getDetailOrtu(id, callback) {
      if(id) {
          ...
          $('#tempat_lahir_ortu').val(data[0].tempat_lahir);
          $('#tanggal_lahir_ortu').datepicker('setDate', data[0].tanggal_lahir);
          $('#pekerjaan_ortu').val(data[0].pekerjaan);
          $('#pendidikan_ortu').val(data[0].pendidikan);
    ...
    $('#tanggal_lahir, #tanggal_lahir_ortu').datepicker({
      format: "yyyy-mm-dd"
    });
   ...
   /* $selectizeProvinsi = $('#provinsi').selectize({
    ...
    function showModalForm(e) {
      ...
      if(!id) {
        $('#formAdd').attr('action', "<?php echo base_url()?>sekolah/siswa/do_add");
        $('#modalFormHeader').text('Tambah Siswa Sekolah (PG/TK/SD)');
        $('#modalForm').modal('show');
      }
      //jika klik tombol edit data:
      else {
        $('#formAdd').attr('action', "<?php echo base_url()?>sekolah/siswa/do_edit");
        $('#modalFormHeader').text('Ubah Siswa Sekolah (PG/TK/SD)');
        getDetail(id);
      }
    }
    //SHOW MODAL FORM
    function showModalFormOrtu(e) {
      ...
      //jika klik tombol tambah data:
      if(!id) {
        $('#formAddOrtu').attr('action', "<?php echo base_url()?>sekolah/siswa/do_add_ortu");
        $('#modalFormOrtuHeader').text('Tambah Orang Tua Siswa Sekolah (PG/TK/SD)');
        $('#modalFormOrtu').modal('show');
      }
      //jika klik tombol edit data:
      else {
        $('#formAddOrtu').attr('action', "<?php echo base_url()?>sekolah/siswa/do_edit_ortu");
        $('#modalFormOrtuHeader').text('Ubah Orang Tua Siswa Sekolah (PG/TK/SD)');
        getDetailOrtu(id);
      }
    }
    ...
    function showDetailOrtu(e) {
      ...
      if(id) {
        $.ajax({
          url: '<?php echo base_url();?>sekolah/siswa/get_ortu_by_id',
          data: { siswa_id : id },
          type: 'POST',
          dataType: 'json',
    ...
    function showDetailKesehatan(e) {
      ...
      if(id) {
        $.ajax({
          url: '<?php echo base_url();?>sekolah/siswa/get_kesehatan_by_id',
          data: { siswa_id : id },
          type: 'POST',
          dataType: 'json',
          beforeSend: () => { $.LoadingOverlay("show"); },
    ...
    function showDetailIsian(e) {
      ...
      if(id) {
        $.ajax({
          url: '<?php echo base_url();?>sekolah/siswa/get_isian_by_id',
          data: { siswa_id : id },
          type: 'POST',
          dataType: 'json',
          beforeSend: () => { $.LoadingOverlay("show"); },
    ...
    function doMultiDelete(arrData, targetTable='') {
      ...
      let url = "<?php echo base_url()?>sekolah/siswa/do_delete";
      if(targetTable == 'ortu') {
        url = "<?php echo base_url()?>sekolah/siswa/do_delete_ortu";
      }
      if(ids[0] != null) {
