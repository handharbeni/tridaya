              ...
              <div class="modal-content">
                <form action="" method="POST" id="formAdd">      
                  <div class="modal-header">
                    <h4 id="modalFormHeader">Tambah Guru</h4>
                  </div>
                   ...
                   <div class="row">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                         ...
                         <input type="text" name="panggilan" id="panggilan" class="form-control" placeholder="Nama Panggilan" required="">
                       </div>
                     </div>
                     <div class="col-sm-6">
                       <div class="form-group">
                     ...
                     <div class="col-sm-12">
                       <div class="form-group">
                         ...
                         <input type="text" name="alamat" id="alamat" class="form-control" rows="2" placeholder="Alamat">
                       </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="form-group">
                     ...
                     <div class="col-sm-6">
                       <div class="form-group">
                         ...
                         <select  onchange="" name="status_peg" id="status_peg" class="form-control" required="">
